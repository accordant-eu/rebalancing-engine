...
- **Next Steps:** Treat generic tax-lot allocation foundations, optimizer feasibility, production-boundary deferral, CLI foundations, and scheduled/recurring cash-flow semantics as complete for offline deterministic fixtures. The next recommended slice is documentation/developer-experience consolidation, followed by CI or fixture/schema hardening unless concrete production consumer/security/persistence requirements are supplied.
...
| 2026-05-02 | Consolidate user/developer docs around observed behavior                           | Accepted                    | README should stay concise while detailed guides own user workflows, CLI reference, architecture, strategy extension rules, and examples; this prevents stale long-form material in the entry point.                     | Documentation pass             | High          | Keep guides updated with future behavior changes                        |
...
Decision: Prioritize scheduled/recurring cash-flow semantics next
...
Decision: Require CLI exposure decisions for future engine capabilities
...
Decision: Consolidate user/developer docs around observed behavior
