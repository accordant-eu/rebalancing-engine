...
| Date | Change |
|------|--------|
| 2026-08-31 | `docs/decisions/0064-automated-recurring-mandate-scheduler.md` | Major | Recorded ADR-0064 for Automated Recurring Mandate Scheduler Service. |
| 2026-08-31 | `docs/iterations/2026-08-31-automated-recurring-mandate-scheduler.md` | Minor | Implemented MandateSchedulerService, calendar math, auto-advance, and REST scan endpoint. |
