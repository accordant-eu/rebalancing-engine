...
| Fixtures/scenario runner           | Implemented                                  | `tests/fixtures/scenarios.json`, runner manifest validation                                       | `batch` and legacy `scenario:run`                                                                           | Fixture and runner tests                                                                                          | 26 synthetic scenarios currently documented (see `scenarios.json`).                                 |
